...
export const seedProfiles: Profile[] = [
  { id: "u-res-1", full_name: "Anna Kowalska", email: "anna@test.pl", phone: "+48 600 100 200", role: "resident", created_at: daysAgo(120) },
  { id: "u-res-2", full_name: "Piotr Nowak", email: "piotr@test.pl", phone: "+48 600 200 300", role: "resident", created_at: daysAgo(80) },
  { id: "u-res-3", full_name: "Magdalena Zielińska", email: "magda@test.pl", phone: "+48 600 300 400", role: "resident", created_at: daysAgo(60) },
  { id: "u-mgr-1", full_name: "Jan Nowak", email: "jan.nowak@propertycare.pl", phone: "+48 500 500 500", role: "manager", created_at: daysAgo(300) },
  { id: "u-tech-1", full_name: "TechFix", email: "kontakt@techfix.pl", phone: "+48 700 100 100", role: "technical", created_at: daysAgo(200) },
  { id: "u-clean-1", full_name: "CleanHome", email: "biuro@cleanhome.pl", phone: "+48 700 200 200", role: "cleaning", created_at: daysAgo(200) },
];
...
export const seedRequests: MaintenanceRequest[] = [
  ...
  },
  {
    ...
    attachments: [], settlement: { amount: 180, payer: "zarządca", status: "opłacone" }, reminders: [],
...
export const seedTechEntries: TechnicalEntry[] = [
  { id: "t-1", apartment_id: "a-1", request_id: "r-4", type: "przegląd", description: "Roczny przegląd kotła – sprawny.", status: "zakończone", assigned_person: "TechFix", created_at: daysAgo(20) },
  ...
  { id: "t-3", apartment_id: "a-3", request_id: null, type: "naprawa", description: "Wymiana baterii kuchennej.", status: "zakończone", assigned_person: "TechFix", created_at: daysAgo(60) },
];

export const seedPayments: Payment[] = [
  { id: "p-1", apartment_id: "a-1", resident_id: "u-res-1", amount: 2800, due_date: daysAhead(-8), status: "zaległa", description: "Czynsz – październik", recurring: true, status_history: [
    { at: daysAgo(35), from: null, to: "nierozliczona", by_role: "manager", by_name: "Jan Nowak" },
    { at: daysAgo(7), from: "nierozliczona", to: "zaległa", by_role: "manager", by_name: "System" },
  ], created_at: daysAgo(35) },
  { id: "p-2", apartment_id: "a-1", resident_id: "u-res-1", amount: 2800, due_date: daysAhead(5), status: "nierozliczona", description: "Czynsz – listopad", recurring: true, status_history: [
    { at: daysAgo(2), from: null, to: "nierozliczona", by_role: "manager", by_name: "Jan Nowak" },
  ], created_at: daysAgo(2) },
  { id: "p-3", apartment_id: "a-2", resident_id: "u-res-2", amount: 3200, due_date: daysAhead(-10), status: "zaległa", description: "Czynsz – październik", recurring: true, status_history: [
    { at: daysAgo(40), from: null, to: "nierozliczona", by_role: "manager", by_name: "Jan Nowak" },
    { at: daysAgo(9), from: "nierozliczona", to: "zaległa", by_role: "manager", by_name: "System" },
  ], created_at: daysAgo(40) },
  { id: "p-4", apartment_id: "a-3", resident_id: "u-res-3", amount: 2500, due_date: daysAhead(7), status: "nierozliczona", description: "Czynsz – listopad", recurring: true, status_history: [
    { at: daysAgo(1), from: null, to: "nierozliczona", by_role: "manager", by_name: "Jan Nowak" },
  ], created_at: daysAgo(1) },
];

export const seedLeases: Lease[] = [
  { id: "l-1", apartment_id: "a-1", resident_id: "u-res-1", start_date: "2024-01-01", end_date: "2025-12-31", status: "aktywna", request_status: "brak", request_type: "brak", request_history: [], created_at: daysAgo(300) },
  { id: "l-2", apartment_id: "a-2", resident_id: "u-res-2", start_date: "2024-03-15", end_date: "2026-03-14", status: "aktywna", request_status: "brak", request_type: "brak", request_history: [], created_at: daysAgo(250) },
  { id: "l-3", apartment_id: "a-3", resident_id: "u-res-3", start_date: "2024-06-01", end_date: "2025-05-31", status: "aktywna", request_status: "brak", request_type: "brak", request_history: [], created_at: daysAgo(180) },
];

export const seedVisits: Visit[] = [
  { id: "v-1", apartment_id: "a-1", manager_id: "u-mgr-1", resident_id: "u-res-1", date: daysAhead(10), time: "10:00", purpose: "Wizyta kontrolna – stan techniczny mieszkania", inspector: "Jan Nowak", contact_phone: "+48 500 500 500", status: "zaplanowana", alternative_date: null, status_history: [
    { at: daysAgo(2), from: null, to: "zaplanowana", by_role: "manager", by_name: "Jan Nowak" },
  ], created_at: daysAgo(2) },
  { id: "v-2", apartment_id: "a-2", manager_id: "u-mgr-1", resident_id: "u-res-2", date: daysAhead(-5), time: "14:00", purpose: "Kontrola stanu mieszkania", inspector: "Jan Nowak", contact_phone: "+48 500 500 500", status: "zrealizowana", alternative_date: null, status_history: [
    { at: daysAgo(20), from: null, to: "zaplanowana", by_role: "manager", by_name: "Jan Nowak" },
    { at: daysAgo(5), from: "zaplanowana", to: "zrealizowana", by_role: "manager", by_name: "Jan Nowak" },
...
export const seedNotifications: Notification[] = [
  { id: "n-1", user_id: "u-res-1", title: "Aktualizacja zgłoszenia", message: "Zgłoszenie ZG-2025-001 zostało przyjęte do realizacji.", type: "request", is_read: false, link: "/resident/requests/r-1", details: "Firma techniczna TechFix przyjęła Twoje zgłoszenie i zaplanowała wymianę syfonu na jutro.", created_at: daysAgo(1) },
  { id: "n-2", user_id: "u-mgr-1", title: "Nowe zgłoszenie", message: "Mieszkaniec utworzył zgłoszenie ZG-2025-002.", type: "request", is_read: false, link: "/manager/requests/r-2", details: "Wymaga przypisania firmy technicznej.", created_at: daysAgo(1) },
  { id: "n-3", user_id: "u-tech-1", title: "Przypisano zgłoszenie", message: "Przypisano nowe zgłoszenie ZG-2025-001.", type: "assignment", is_read: false, link: "/technical/r-1", created_at: daysAgo(2) },
  { id: "n-4", user_id: "u-res-1", title: "Płatność", message: "Naliczono nowy czynsz – listopad.", type: "payment", is_read: true, link: "/resident/payments", created_at: daysAgo(2) },
];
